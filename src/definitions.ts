...
export interface IParamaterizedStringOptions
  extends INumberOptions,
    IParameterizedOptionsBase {}

export interface IParamaterizedNumberOptions
  extends INumberOptions,
    IParameterizedOptionsBase {}

export interface IParamaterizedBooleanOptions
  extends IBooleanOptions,
    IParameterizedOptionsBase {}

export interface IParameterizedObjectOptions
